...
000092aa   7640       LCR          0x009581 // 调用DisableNMI_test
000092ab   9581
000092ac   9647       MOV          *-SP[7], AL
000092ad   7640       LCR          0x00959a // 调用DisableInt_test
000092ae   959a
000092af   9646       MOV          *-SP[6], AL
000092b0   0642       MOVL         ACC, *-SP[2]
000092b1   7640       LCR          0x009235 // 调用OpenPulse_test
000092b2   9235
000092b3   9645       MOV          *-SP[5], AL
000092b4   7640       LCR          0x00925d // 调用MaskAll_test
000092b5   925d
...
000092ca   1999
000092cb   7640       LCR          0x00958d // 调用Delay_test
000092cc   958d
...
000092d4   7640       LCR          0x00958d // 调用Delay_test
000092d5   958d
...
000092dd   7640       LCR          0x00958d // 调用Delay_test
000092de   958d
000092df   7640       LCR          0x009246 // 调用ClosePulse_test
000092e0   9246
000092e1   9246       MOV          AL, *-SP[6]
000092e2   7640       LCR          0x00959e // 调用RestoreInt_test
000092e3   959e
