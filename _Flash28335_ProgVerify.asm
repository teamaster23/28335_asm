...
0000926b   7640       LCR          0x009581 // 调用DisableNMI
0000926c   9581
0000926d   9647       MOV          *-SP[7], AL
0000926e   7640       LCR          0x00959a // 调用DisableInt
0000926f   959a
00009270   9646       MOV          *-SP[6], AL
00009271   0642       MOVL         ACC, *-SP[2]
00009272   7640       LCR          0x009235 // 调用OpenPulse
00009273   9235
...
00009281   1999
00009282   7640       LCR          0x00958d // 调用Delay
00009283   958d
...
0000928c   7640       LCR          0x00958d // 调用Delay
0000928d   958d
...
0000929a   7640       LCR          0x00958d // 调用Delay
0000929b   958d
0000929c   7640       LCR          0x009246
0000929d   9246
0000929e   9246       MOV          AL, *-SP[6]
0000929f   7640       LCR          0x00959e // 调用RestoreInt
000092a0   959e
